                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-center mb-5">
                            <p className="brand_subtitle">Explorez une gamme de nouvelles marques captivantes ! </p>
                            <h2 className="brand_title">
Découvrez les dernières marques</h2>
                        </div>
                    </div>
                    {loading ?
                        ...
                        <>
                            ...
                            <div className="col-12 text-center">
                                <Link to='/brands' className='btn btn-lg text-white' style={{ backgroundColor: '#d11a2a' }}>
