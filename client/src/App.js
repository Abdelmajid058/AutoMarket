...
// Importez le composant Chatbot depuis le chemin correct
...
function App() {
  return (
    <Router>
      <Navbar/>
      {/* Supprimez le h1 si vous ne voulez pas qu'il s'affiche en permanence */}
      {/* <h1>Bienvenue chez AutoMarket !</h1> */}
      
      {/* Intégrez le chatbot ici. Il est positionné en fixe via CSS. */}
      <Chatbot />
